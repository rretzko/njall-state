        ...
        <div >
            ...
            <div class="mt-1 flex flex-col justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                ...
                <div style="border: 1px solid black; padding: 1rem; background-color: rgba(0,0,0,0.1);">
                    ...
                    <header>Please add an event</header>

                    <form method="post" action="{{ route('siteadmin.event.store') }}">

                        @csrf

                        <div class="mb-4 flex flex-col">
                            <label for="last" class="font-bold">Name</label>
                            <input type="text" name="name" id="name" value="" />
                        </div>

                         <div class="mb-4 flex flex-col">
                            <label for="year_of" class="font-bold">Year</label>
                            <input type="text" name="year_of" id="year_of" value="" style="width: 6rem;"/>
                        </div>

                        <div class="mb-4 flex flex-col">
                            <label for="program_link" class="font-bold">Program Link</label>
                            <input type="text" name="program_link" id="program_link" value="" />
                        </div>
